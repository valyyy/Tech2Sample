Feature: Register
  ...
  Scenario Outline: Trying to register using invalid info will result this errors
    Given I am on RegisterPage
    When I try to register using <status> information
    Then I should see this error:
    """
  Email nije ispravan
  Lozinka je prekratak (ne manje od 6 karaktera)
  Ime tvrtke mora biti ispunjeno
  OIB nije odgovarajuće dužine (mora imati 11 karaktera)
  """
  Examples:
    | status |
    |invalid |
